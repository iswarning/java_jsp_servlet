                ...
                <div class="col-sm-9">
                    <div class="row">
                            <div class="col-12 col-md-6 col-lg-4 mb-2">
                                <div class="card">
                                    <img class="card-img-top" src="${pro.getHinhAnh()}" alt="Card image cap" width="252px" height="290px">
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="detail?id=${pro.getId()}" title="View Product">${pro.getTenSanPham()}</a></h4>
                                        <div class="row">
                                            <div class="col">
                                                <p class="btn btn-danger btn-block"><fmt:formatNumber value = "${pro.getGia()}"/> VND</p>
                                            </div>
                                            <div class="col">
                                                <form action="cart" method="post">
                                                	<input type='hidden' value='addToCart' name='action'/>
                                                	<input type="hidden" value='${pro.getId()}' name='proId'/>
